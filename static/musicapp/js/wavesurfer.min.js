        ...
        p = (function (e) {
          function i(e) {
            ...
            return (
              ...
              (n.states =
                (a((r = {}), h, Object.create(n.stateBehaviors[h])),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.scriptNode.onaudioprocess = function () {
                    ...
                    e >= t.getDuration()
                      ? (t.setState(d), t.fireEvent("pause"))
                      : e >= t.scheduledPause
                      ? t.pause()
                      : t.state === t.states[h] &&
      ...
      var m = (function (e) {
        function n(e) {
          ...
          if (
            ...
            (t.backends = { MediaElement: o.default, WebAudio: s.default }),
            (t.util = i),
            (t.params = i.extend({}, t.defaultParams, e)),
            (t.container =
              "string" == typeof e.container
                ? document.querySelector(t.params.container)
                : t.params.container),
            !t.container)
          )
            throw new Error("Container element not found");
          if (
            (null == t.params.mediaContainer
              ? (t.mediaContainer = t.container)
              : "string" == typeof t.params.mediaContainer
              ? (t.mediaContainer = document.querySelector(
                  t.params.mediaContainer
                ))
              : (t.mediaContainer = t.params.mediaContainer),
            !t.mediaContainer)
          )
          ...
          var r = 0;
          return (
            (t._onResize = i.debounce(
              function () {
                r == t.drawer.wrapper.clientWidth ||
                  t.params.scrollParent ||
                  ((r = t.drawer.wrapper.clientWidth),
          ...
          y(n, [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                t.staticProps &&
                  Object.keys(t.staticProps).forEach(function (e) {
                    r[e] = t.staticProps[e];
                  });
                var n = t.instance;
                return (
            ...
            },
            {
              key: "zoom",
              value: function (e) {
                (this.params.scrollParent = e
                  ? ((this.params.minPxPerSec = e), !0)
            ...
            },
            {
              ...
              value: function (t, e, r) {
                var n = this,
                  i = function (e) {
                    return (
                      e && n.tmpEvents.push(n.once("ready", e)),
    ...
    function (e, t) {
      function r(t, r, n) {
        ...
        function l() {
          ...
          e < r && 0 <= e
            ? (i = setTimeout(l, r - e))
            : ((i = null), n || ((u = t.apply(s, a)), (s = a = null)));
        }
        null == r && (r = 100);
        var e = function () {
      ...
      var c = (function (e) {
        function n(e, t) {
          ...
          return (
            ...
            ((r = o(this, u(n).call(this, e, t))).maxCanvasWidth =
              t.maxCanvasWidth),
            ...
            },
            {
              ...
              value: function () {
                ...
                this.canvases.forEach(function (e, t) {
                  var r =
                    n.maxCanvasWidth + 2 * Math.ceil(n.params.pixelRatio / 2);
                  t == n.canvases.length - 1 &&
                    (r = n.width - n.maxCanvasWidth * (n.canvases.length - 1)),
                ...
                return this.prepareDraw(e, t, v, y, function (e) {
                  ...
                  if (void 0 !== v) {
                    var s,
                      ...
                      c =
                        l +
                        (null === m.params.barGap
                          ? Math.max(m.params.pixelRatio, ~~(l / 2))
                          : Math.max(
                              m.params.pixelRatio,
                ...
                for (i = a; i < s; i++) {
                  var o = this.canvases[i],
                    ...
                    l = {
                      ...
                      x2: Math.min(
                        e + r,
                        i * this.maxCanvasWidth + o.waveCtx.canvas.width
                      ),
                      y2: t + n,
                    };
                  l.x1 < l.x2 &&
                ...
                return f.frame(function () {
                  if (s[0] instanceof Array) {
                    ...
                    if (h.params.splitChannels)
                      return (
                        h.setHeight(
                          e.length * h.params.height * h.params.pixelRatio
                        ),
              ...
              value: function (e, t) {
                ...
                return (
                  !this.params.fillParent && a < s
                    ? 1 <
                        (r =
                          (n - i.left) * (this.params.pixelRatio / a) || 0) &&
                      (r = 1)
                    : (r =
                        (n - i.left + this.wrapper.scrollLeft) /
            ...
            },
            {
              ...
              value: function () {
                ...
                this.wrapper.addEventListener("click", function (e) {
                  ...
                  n.params.interact &&
                    n.fireEvent("click", e, n.handleEvent(e));
                }),
        ...
        return (
          ...
          (r = [
            ...
            },
            {
              ...
              value: function (e, t, r) {
                return this.buffer
                  ? u(l(n.prototype), "getPeaks", this).call(this, e, t, r)
                  : this.peaks || [];
              },
            },
            {
